...
import com.transaction_service.transaction.infra.sale.output.notify.SaleMessageSender;
import com.transaction_service.transaction.infra.sale.output.notify.SaleNotify;
import com.transaction_service.transaction.infra.sale.output.persistence.ISaleMapper;
import com.transaction_service.transaction.infra.sale.output.persistence.ISaleRepository;
import com.transaction_service.transaction.infra.sale.output.persistence.SaleAdapter;
